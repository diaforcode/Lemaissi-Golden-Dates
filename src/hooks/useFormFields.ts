...
const useFormFields = ({ slug, translations }: Props) => {
  ...
  const addProductFields = (): IFormField[] => [
    ...
    {
      label: translations.admin["menu-items"].form.nameArabic.label,
      name: "nameArabic",
      type: "text",
      placeholder: translations.admin["menu-items"].form.nameArabic.placeholder,
      autoFocus: true,
    },
    {
    ...
    {
      label: translations.admin["menu-items"].form.descriptionArabic.label,
      name: "descriptionArabic",
      type: "text",
      placeholder:
        translations.admin["menu-items"].form.descriptionArabic.placeholder,
    },
    {
      label: translations.admin["menu-items"].form.price.label,
      name: "price",
      type: "text",
      placeholder: translations.admin["menu-items"].form.price.placeholder,
    },
  ];
  const addCategoryFields = (): IFormField[] => [
    {
      label: translations.admin["menu-items"].form.name.label,
      name: "name",
      type: "text",
  ...
  const getFormFields = (): IFormField[] => {
    switch (slug) {
      ...
      case `${Routes.ADMIN}/${Pages.CATEGORIES}`:
        return addCategoryFields();
      default:
        return [];
    }
  };
